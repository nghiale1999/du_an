...
$email_s=$_GET['email'];
$product = '<a href="product.php?email='.$email_s.'"></i> Product</a>';
$account = '<a href="account.php?email='.$email_s.'"><i class="fa fa-user"></i> Account</a>';
...
if(isset($_POST['submit'])){
    ...
    if($check == 1){
        ...
        $sql = "INSERT INTO product (hinh,ten,gia,email) 
        VALUES ('$hinh', '$ten','$gia','$email_s')";
