...
$login='<a href=""><i class="fa fa-lock"></i> Login</a>';
$account='<a href=""><i class="fa fa-user"></i> Account</a>';
...
if(isset($_POST['submit'])){
	...
	if(!isset($_POST['checkbox'])){
		$error_checkbox = 'moi tich dong y';
        $check =2 ;
	}
    ...
    if($check == 1){
       ...
       if($result->num_rows > 0){
			...
			$login='<a href="register.php"><i class="fa fa-lock"></i> Logout</a>';
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						<h2><h2><b><?php echo $error;  ?></b></h2></h2>
