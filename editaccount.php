...
$product = '<a href="product.php"></i> Product</a>';
$addpr = '<a href="addpr.php">Add Product</a>';
$account = '<a href="account.php"><i class="fa fa-user"></i> Account</a>';
$error='nhap thong tin mới!';
$check=1;
$error_anh='';
$error_ten='';
$error_email='';
...
if(isset($_POST['submit'])){
    ...
    if($check == 1){
        ...
        $sql = "UPDATE tb_user SET email = '$email', password = '$pass',name = '$name',avatar = '$avatar'
		WHERE id='".$id."'";
...
//unlink("pictures/flower.png");
        ...
        if ($result = $con->query($sql)) {
            $error = 'update thanh công';
			$account = '<a href="account.php"><i class="fa fa-user"></i> Account</a>';
			move_uploaded_file( $file['tmp_name'],'images/'.$file['name']);
        }else{
            $error = 'update thất bại có thể email bị trùng';
...
<head>
    ...
    <title>Edit Account | E-Shopper</title>
